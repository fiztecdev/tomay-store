...
--
-- Host: 127.0.0.1    Database: tomaystore
-- ------------------------------------------------------
...
INSERT INTO `hotel` VALUES (1,'sd','s',NULL,'hotel.svg','1'),(2,'xxx1','jr.mazano',NULL,'hotel.svg','1'),(3,'bora hotel','Iquitos, a 0.9 km de: centro de la ciudad',NULL,'hotel.svg','1'),(4,'acosto','iquitos, a 0.5 km de: centro de la ciudad',NULL,'hotel.svg','1'),(14,'Hotel Rivera','Av. Navarrete 1137','Habitaciones increibles y precios comodos para miembros de empresas','hotel.svg','0'),(15,'Westin','San Isidro','buena descripcion del hotel','hotel.svg','0'),(16,'dbgdgd','gegege',NULL,'hotel.svg','0'),(17,'ESPAÑA WINNER','BARCELONA',NULL,'hotel.svg','1');
...
INSERT INTO `oauth_personal_access_clients` VALUES (1,1,'2017-11-19 17:29:25','2017-11-19 17:29:25');
...
INSERT INTO `pq_turistico` VALUES (1,'panamericana ',34.00,'2 dias ',1,1,2,'1','0',100.00,'0',NULL,NULL),(2,'ruta corta',344.00,'tres dias',1,1,2,'1','0',0.00,'0',NULL,NULL),(3,'ruta corta',344.00,'1 dias',1,1,2,'1','0',0.00,'0',NULL,NULL),(4,'toda la ciudad',300.00,'2',2,4,6,'1','0',0.00,'0',NULL,NULL),(9,'dfgh',855.00,'2 dias',2,3,1,'1','0',0.00,'0',NULL,NULL),(10,'ertyuiop',9852.00,'5dias mas una noche',2,3,4,'1','0',0.00,'0',NULL,NULL),(11,'lsdfghjk',696.00,'4 dias',1,2,5,'1','0',34.89,'0',NULL,NULL),(12,'lsdfghjk',696.00,'4 dias',1,2,5,'1','0',0.00,'0',NULL,NULL),(13,'sdfgh',524.00,'3d',1,2,3,'1','0',0.00,'0',NULL,NULL),(14,'sdfg update',223.00,'2 dias',3,1,5,'1','1',0.00,'0',NULL,NULL),(15,'rusia',2424.00,'23 dias',3,1,1,'0','0',0.00,'0',NULL,NULL),(16,'FRANCIA',224.00,'100 DIAS',4,2,4,'0','0',0.00,'0',NULL,NULL),(17,'CUSCO',2000.00,'3 DIAS',17,6,7,'1','0',0.00,'0',NULL,NULL),(18,'NUEVAS RUTAS',4435.00,'232 DIAS',14,6,7,'1','0',0.00,'0',NULL,NULL),(19,'TT NUEVO',65566.00,'23 dias',15,3,5,'1','1',56.00,'0','2019-06-14 05:05:00',NULL);
...
INSERT INTO `restaurante` VALUES (1,'restaurante','lima','playa-plana-885x500.jpg',NULL,'1'),(2,'amazon','Av La Marina N 134-B, Iquitos, Perú','terrr.jpg',NULL,'1'),(3,'karma cafe','Calle Napo 138 | 138 rue Napo, Iquitos 16000, Perú','restss.jpg',NULL,'1'),(4,'karma cafe','Calle Napo 138 | 138 rue Napo, Iquitos 16000, Perú','resta.jpg',NULL,'1'),(5,'TASITAS FOOD MAS','Francia','rrr.jpg',NULL,'1'),(6,'BUEN IDE','EL RESTAURANTE GENIAL','intellij.png',NULL,'1');
...
CREATE TABLE `users` (
  ...
  `type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'cliente',
...
INSERT INTO `users` VALUES (1,'Administrador','adminuser','adminuser@gmail.com','$2y$10$yFgBxiRN1mEM6n3oT4CkTuvLoOG9NhniwuuG/242NO.02cC5Rwbcy','admin','init.svg','8U2qAJmX1qePtdJfLC2DUluTW6U9Cnk7mHtDWmRZ0Cp82Ywe1wAZxinm0aXD','2017-11-17 07:14:30','2017-11-17 07:14:30'),(2,'Fideliño','feviva','villanuevafidel_1996@icloud.com','$2y$10$BDuydOXT.0ul9MiDKvFMSe4FECY4O6XKTTzkylpahw2SY7CdB2e2W','cliente',NULL,'fuGDWV8V9RJ7oOlUnL56p7QuYS3oi10zHyhkeL1frmTOwxIn5DbQ016X45P9','2019-06-14 03:25:34','2019-06-14 03:25:34');
...
-- Dump completed on 2019-06-14 10:00:12
